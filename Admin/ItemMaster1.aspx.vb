...
Partial Class ItemMaster
    ...
    Protected Sub odsItemDetails_Inserting(sender As Object, e As System.Web.UI.WebControls.ObjectDataSourceMethodEventArgs) Handles odsItemDetails.Inserting
        odsItemDetails.InsertParameters("ProdGroup").DefaultValue = 0
    End Sub
End Class
