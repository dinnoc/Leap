        ...
        <tr>
            <td valign="top">
                <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
                    DataKeyNames="ItemCode" DataSourceID="odsItemDetails" 
                    ...
                    <Fields>
                        ...
                        <asp:TemplateField HeaderText="ProdGroup" SortExpression="ProdGroup">
                            <EditItemTemplate>
                                <asp:DropDownList ID="DropDownList5" runat="server" DataSourceID="odsProdGroup" 
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="GridView2" runat="server" AllowSorting="True" 
                    ...
                    DataSourceID="odsItemRouting" Width="100%" EnableModelValidation="True">
                    <Columns>
