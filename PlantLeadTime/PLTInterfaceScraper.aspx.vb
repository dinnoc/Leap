...
Partial Class PLTInterfaceScraper
    ...
    Protected Sub BtnRunInterface_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnRunInterface.Click
        ...
        Response.Write(Now & "   Get ItemCode data Start<br/>")
        clInterface.GetXFPItemsToLeapItemTable()
        Response.Write(Now & "   Get ItemCode data End<br/>")
...
#End Region
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCleanUp.Click
        Dim qAdap As New PLTInterfaceTableAdapters.QueriesTableAdapter
