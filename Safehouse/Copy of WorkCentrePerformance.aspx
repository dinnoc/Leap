 <%@ Page Title="Work Centre Performance" Language="VB" MasterPageFile="~/LeaPBack.master" AutoEventWireup="false" CodeFile="Copy of WorkCentrePerformance.aspx.vb" Inherits="WorkCentrePerformance" %>
                 ...
                 <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
                    ...
                    <Columns>
                        ...
                        <asp:ButtonField CommandName="Exception" ShowHeader="True" Text="Exception" 
                            HeaderText="Exception" SortExpression="Exception">
