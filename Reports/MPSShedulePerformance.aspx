<%@ Page Title="" Language="VB" MasterPageFile="~/LeaPBack.master" AutoEventWireup="false" CodeFile="MPSShedulePerformance.aspx.vb" Inherits="Reports_MPSShedulePerformance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style1">
        <tr>
            <td colspan="7">
                <h3>
                    MPS Workcentre Performance</h3><asp:ScriptManager ID="ScriptManager1" runat="server">
                    </asp:ScriptManager>
            </td>
        </tr>
        <tr>
