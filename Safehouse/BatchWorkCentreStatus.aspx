<%@ Page Language="VB" AutoEventWireup="false" CodeFile="BatchWorkCentreStatus.aspx.vb" MasterPageFile ="~/LeaPBack.master"  Inherits="BatchWorkCentreStatus" %>
                ...
                <td>
                    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="TPCOrderNo" HeaderText="Order No" 
                                SortExpression="TPCOrderNo" />
                            <asp:BoundField DataField="TPCOrderQuantity" HeaderText="Quantity" 
                            ...
                            <asp:BoundField DataField="WorkCentreDesc" HeaderText="Last Work Centre" 
                                SortExpression="WorkCentreDesc" >
                            <ItemStyle HorizontalAlign="Center" Width="300px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="EndDate" HeaderText="Target End Date" 
                                SortExpression="EndDate" DataFormatString="{0:d}" >
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="TransDate" HeaderText="Actual End Date" 
                                SortExpression="TransDate" DataFormatString="{0:d}" >
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            <asp:BoundField DataField="nextWorkCentre" HeaderText="Next Work Centre" 
                                SortExpression="nextWorkCentre" >
                            <ItemStyle HorizontalAlign="Center" Width="300px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="nextEndDate" HeaderText="Target End Date" 
                                SortExpression="nextEndDate" DataFormatString="{0:d}" >
                            <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
            ...
            <tr>
                <td>
                    <asp:ObjectDataSource ID="odsBatchWorkCentre" runat="server" 
                        OldValuesParameterFormatString="original_{0}" SelectMethod="GetDataAllBatches" 
                        TypeName="dsBatchTableAdapters.BatchWorkCentreStatusTableAdapter">
