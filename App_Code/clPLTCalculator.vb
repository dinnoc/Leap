...
Public Class clPLTCalculator

    Dim RouteHeaderID As Integer

#Region "PLTCalculator"
    Sub CalculatePlantLeadTime(ByVal routeID As Integer)
        Dim starttime As DateTime = Now()

        'set calc in use to true
        Dim adapQ As New PLTReportingTableAdapters.QueriesTableAdapter
        adapQ.UpdateCalcInUse(True)



        RouteHeaderID = routeID
        ...
        Dim adapFile As New InterfaceScraperTableAdapters.LeaP_InterfaceFilesTableAdapter

        Dim adapCalcControl As New PLTReportingTableAdapters.PLT_Calculator_ControlTableAdapter
        adapCalcControl.Update(False, Now(), routeID, 1)
